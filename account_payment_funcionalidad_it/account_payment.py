			...
			if inv.currency_id.name == 'USD':
				...
				if inv.move_line_ids.ids:
					...
					for elem in inv.move_line_ids:
						...
						if self.journal_id.default_debit_account_id.id == elem.account_id.id:
				...
				if inv.move_line_ids.ids:
					...
					for elem in inv.move_line_ids:
						...
						if self.journal_id.default_debit_account_id.id == elem.account_id.id and  not inv.rendicion_id.id:
							elem.nro_comprobante =  self.nro_caja
							elem.type_document_it = self.tipo_caja.id
