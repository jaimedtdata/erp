    ...
    var ItemzTree = Widget.extend({
        ...
        OnRename: function (event, treeId, treeNode, isCancel) {
            ...
            if (!isCancel) {
                ...
                parent.dataset.write(r_id, data, {}).then(function (ev) {
                    ...
                    var match_item = _.find(parent.rows_to_gantt, function (item) {
        ...
        fold_bar: function (node, childs, fold) {
            ...
            _.each(childs, function (child) {
                var match_task_id = _.find(self.parent.rows_to_gantt, function (item) {
            ...
            if (node["id"]) {
                ...
                var task_model = self.parent.dataset.model;


                var p_model = new Model(task_model);


                p_model.call('fold_update', [fold_dic])
                    .then(function (ev) {
        ...
        open_record: function (event, options) {
            ...
            if (event.data.is_group == false && this.parent.dataset.select_id(event.data.id)) {

                res_id = event.data.id;

                res_model = this.parent.dataset.model;
            ...
            if (res_open) {
                ...
                new form_common.FormViewDialog(this.parent, {
                    ...
                    context: this.parent.dataset.get_context(),
                    readonly: readonly,
                    buttons: buttons
                ...
                this.parent.do_warn("Gannt: Open Only - Project or Task # " + event.data.id);
            }
        },
        ...
        onDrop: function (ev, treeId, treeNodes, targetNode, moveType) {
            ...
            if (targetNode && targetNode.drop !== false) {
                ...
                if (match_task) {
                    ...
                    var parent = targetNode.widget_parent;
                    var task_model = parent.dataset.model;


                    var p_model = new Model(task_model);


                    p_model.call('tree_update', [rows_to_gantt, treeNode.zt_id, zt_pId])
                        .then(function (ev) {
        ...
        add_record: function (event) {
            ...
            var context = this.parent.dataset.get_context();
            var self = this.parent;
