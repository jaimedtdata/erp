...
class ProjectTaskResourceLink(models.Model):
    ...
    def _compute_name_link(self):
        ...
        el1 = self.decodepy2(self.project_id.name)
        el2 = self.decodepy2(self.task_id.name)
        el3 = self.decodepy2(self.resource_id.name)
        el4 = self.decodepy2(self.load_factor)

        self.name = "{}-{} ({}) {}".format(el1, el2, el3, el4)
