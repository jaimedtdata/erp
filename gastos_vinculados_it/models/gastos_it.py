...
class gastos_vinculados_it(models.Model):
	...
	amount_invoice_ref = fields.Monetary('Valor', digits=(
		12, 2), related='invoice_id.amount_untaxed')

	amount_invoice = fields.Monetary('Valor', digits=(
		12, 2))

	amount_purchase_ref = fields.Monetary('Valor', digits=(12, 2),  related='purchase_order_id.amount_untaxed')
	amount_purchase = fields.Monetary(	'Valor', digits=(12, 2))
