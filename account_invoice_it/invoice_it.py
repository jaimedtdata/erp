...
class account_invoice(models.Model):
	...
	@api.constrains('it_type_document','sunat_transaction_type')
	def _constraint_type_document(self):
		for inv in self:
			if inv.it_type_document.code == '07' and inv.type in ('in_refund','out_refund') and inv.sunat_transaction_type == 4:
				raise UserError('No se puede seleccionar Venta Interna Anticipos para una Nota de Credito')
