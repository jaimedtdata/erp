...
ELSE '' END as campo25,
CASE WHEN compra.tipodecambio is not Null THEN ( round(compra.tipodecambio,3) )::varchar ELSE '1.000' END as campo26,
...
ELSE '' END as campo17,
CASE WHEN compra.tipodecambio is not Null THEN ( round(compra.tipodecambio,3) )::varchar ELSE '1.000' END as campo18,
