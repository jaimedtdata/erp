...
class account_invoice(models.Model):
	...
	def write(self,vals):
		...
		for i in self.invoice_line_ids:
			if param.advance_product_id.id and param.advance_product_id.id == i.product_id.id and self.sunat_transaction_type != '4' and self.state == 'open' and self.type in ('out_invoice','out_refund'):
